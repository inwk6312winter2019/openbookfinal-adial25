...
filename = 'Book1.txt'
print(unique_words(filename))
print(count_the_article(filename))
print(sorted_words(filename))
print(character_word_count(filename))
print(starts_with_vow(filename))
print("..........")
